...
本模块定义了与非遗项目相关的所有路由处理函数，包括：
- 项目列表页：展示所有非遗项目，支持分页和分类筛选
- 项目详情页：展示单个非遗项目的详细信息和关联内容
- 项目创建页：提供表单用于创建新的非遗项目（仅限教师）
- 项目编辑页：提供表单用于编辑现有的非遗项目（仅限创建者或管理员）
- 项目删除功能：处理项目删除请求（仅限创建者或管理员）

这些路由共同构成了平台的非遗项目管理功能，是平台核心功能之一。
"""
